    ...
    try:
        ...
        for name, algorithm in algorithms.items():
            ...
            try:
                ...
                plt.close()
                img_buffer.seek(0)
                visualizations[name] = img_buffer
        ...
        visualizations['Metrikler'] = metrics_img_buffer
